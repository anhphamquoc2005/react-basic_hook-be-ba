...
export default function ProductManager() {
    ...
    return (
        <div>
                    ...
                    {products.length === 0 ? (
                        ...
                        products.map(product => (
                            <div key={product.id}>
                                ...
                                <p>Giá: <strong>{product.priceProduct}</strong></p>
                                <p>Mô tả: <strong>{product.describeProduct}</strong></p>
            ...
            <CustomModal isOpen={showModal} title="Lưu thành công!" onClose={() => setShowModal(false)}>
                {latestProduct && (
                    <div>
                        <p>{latestProduct.nameProduct} vừa được thêm vào danh sách sản phẩm</p>
